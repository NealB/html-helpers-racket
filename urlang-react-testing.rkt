...
(parameterize ([current-urlang-output-file "react-example.js"])
  (urlang
   (urmodule exercise ; saved in exercise.js
             (import delete this Promise fetch Object $ React ReactDOM document document.title JSON RegExp renderHtmlElements attr-prepend include-empty-atts? alter-element-fn form-example alert quote quasiquote unquote unquote-splicing list div p className add1
                     onClick)
             ...
             (define (App1 props)       
               ...
               (render-html-element (div.container
